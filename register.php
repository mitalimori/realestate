...
if(!preg_match("/[0-9]/i", $_POST['pass'])){
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage) && (strlen($_POST['pass']) > 8) && (preg_match("/[a-z]/i", $_POST['pass'])) && (preg_match("/[0-9]/i", $_POST['pass'])))
		{
			...
			$error = "<p class='alert alert-warning'>register not suceesfully</p>";
		}
	}
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<form method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<input type="text"  name="phone" class="form-control" placeholder="Your Phone*" maxlength="10" minlength=10>
									</div>
									<div class="form-group">
